...
%ffinde ich n bisschen holprig, es wird oft gesagt:  uns sind allee adressen bekannt, deswegen ist ess egal und wwir könne unser programm schreiben weil wir alle adsressen kennen


% Ich würde die Struktur abändern wie folgt:
% erste section vllt "Befehlsstruktur" eine Zusammenlegung von
%   32-Bit-Code}
%   Struktur ( Opcode- / Register- / Immediate- Bit-Länge )}
%   Zuweisung des Opcodes}
% zweite section: 
%   Befehlssatz
% Dritte section:
%   Immediate handling
% Diskussion bei Befehlen würd ich als subsection von Immediate handling begreifen
%
%
%
% Zu Diskussion bei Befehlen: Sehr stakatohaftes, pro, con, pro, con
% relative sprünge erläutern

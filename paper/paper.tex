...
\documentclass[paper=a4,fontsize=11pt,twocolumn]{scrreprt}

\usepackage{geometry}
\geometry{margin=2.3cm,marginparwidth=2.0cm,footskip=1.4cm}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width = \textwidth]{images/pc_schaubild.png}

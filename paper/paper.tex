...
%Formulierung - "Komponente" nicht wirklich definiert
...
% Mehr Leben in den Text bringen
% Mehr Pythonsketch / Bild von Pipeline erklären.
...
% Bewertung unserer initialen ziele
...
% Wie ist es gelaufen (Gruppenarbeit)
...
% Was würden wir anders machen (Gruppenarbeit)
...
%diskrete Simulationsumgebung ergibt keinen Sinn mehr --> ghdl + debugger wäre besser
entwickelt werden.

...
public class TestParser extends Parser {
	...
	public static class No_opContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterNo_op(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitNo_op(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Two_opContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterTwo_op(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitTwo_op(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Three_opContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterThree_op(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitThree_op(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Jmp_opContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterJmp_op(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitJmp_op(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Mul_opContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterMul_op(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitMul_op(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Not_opContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterNot_op(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitNot_op(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Save_labelContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterSave_label(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitSave_label(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Load_labelContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterLoad_label(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitLoad_label(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class No_op_opcodeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterNo_op_opcode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitNo_op_opcode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Two_op_opcodeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterTwo_op_opcode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitTwo_op_opcode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Three_op_opcodeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterThree_op_opcode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitThree_op_opcode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Jmp_op_opcodeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterJmp_op_opcode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitJmp_op_opcode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Mul_opcodeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterMul_opcode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitMul_opcode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Not_opcodeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterNot_opcode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitNot_opcode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class RegOneContext extends ParserRuleContext {
		...
		public TerminalNode DECIMAL() { return getToken(TestParser.DECIMAL, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterRegOne(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitRegOne(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final RegOneContext regOne() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(111);
			((RegOneContext)_localctx).registernumber = match(DECIMAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class RegTwoContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterRegTwo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitRegTwo(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final RegTwoContext regTwo() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(114);
			((RegTwoContext)_localctx).registernumber = match(DECIMAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class RegOrImContext extends ParserRuleContext {
		...
		public TerminalNode HEXADECIMAL() { return getToken(TestParser.HEXADECIMAL, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).enterRegOrIm(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TestListener ) ((TestListener)listener).exitRegOrIm(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final RegOrImContext regOrIm() throws RecognitionException {
		...
		try {
			...
			case T__0:
				...
				match(T__0);
				setState(117);
				((RegOrImContext)_localctx).registernumber = match(DECIMAL);
				}
				break;
			case BINARY:
				enterOuterAlt(_localctx, 2);
				{
				setState(118);
				((RegOrImContext)_localctx).immediate = match(BINARY);
				}
				break;
			case DECIMAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(119);
				((RegOrImContext)_localctx).immediate = match(DECIMAL);
				}
				break;
			case HEXADECIMAL:
				enterOuterAlt(_localctx, 4);
				{
				setState(120);
				((RegOrImContext)_localctx).immediate = match(HEXADECIMAL);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\24\26\30\32\34\36 \"$&\2\5\3\2\4\6\3\2\t\24\3\2\7\b\2t\2(\3\2\2\2\49"+
		"\3\2\2\2\6;\3\2\2\2\b>\3\2\2\2\nD\3\2\2\2\fL\3\2\2\2\16R\3\2\2\2\20Z\3"+
		"\2\2\2\22`\3\2\2\2\24b\3\2\2\2\26d\3\2\2\2\30f\3\2\2\2\32h\3\2\2\2\34"+
		"j\3\2\2\2\36l\3\2\2\2 n\3\2\2\2\"p\3\2\2\2$s\3\2\2\2&{\3\2\2\2()\b\2\1"+
		"\2)*\5\4\3\2*/\3\2\2\2+,\f\4\2\2,.\5\4\3\2-+\3\2\2\2.\61\3\2\2\2/-\3\2"+
		"\2\2/\60\3\2\2\2\60\3\3\2\2\2\61/\3\2\2\2\62:\5\6\4\2\63:\5\b\5\2\64:"+
		"\5\n\6\2\65:\5\22\n\2\66:\5\f\7\2\67:\5\16\b\28:\5\20\t\29\62\3\2\2\2"+
		"9\63\3\2\2\29\64\3\2\2\29\65\3\2\2\29\66\3\2\2\29\67\3\2\2\298\3\2\2\2"+
		":\5\3\2\2\2;<\5\26\f\2<=\7\34\2\2=\7\3\2\2\2>?\5\30\r\2?@\5\"\22\2@A\7"+
		"\33\2\2AB\5&\24\2BC\7\34\2\2C\t\3\2\2\2DE\5\32\16\2EF\5\"\22\2FG\7\33"+
		"\2\2GH\5$\23\2HI\7\33\2\2IJ\5&\24\2JK\7\34\2\2K\13\3\2\2\2LM\5\34\17\2"+
		"MN\5\"\22\2NO\7\33\2\2OP\5\24\13\2PQ\7\34\2\2Q\r\3\2\2\2RS\5\36\20\2S"+
		"T\5\"\22\2TU\7\33\2\2UV\5$\23\2VW\7\33\2\2WX\5&\24\2XY\7\34\2\2Y\17\3"+
		"\2\2\2Z[\5 \21\2[\\\5\"\22\2\\]\7\33\2\2]^\5&\24\2^_\7\34\2\2_\21\3\2"+
		"\2\2`a\7!\2\2a\23\3\2\2\2bc\7!\2\2c\25\3\2\2\2de\7\25\2\2e\27\3\2\2\2"+
		"fg\t\2\2\2g\31\3\2\2\2hi\t\3\2\2i\33\3\2\2\2jk\t\4\2\2k\35\3\2\2\2lm\7"+
		"\31\2\2m\37\3\2\2\2no\7\32\2\2o!\3\2\2\2pq\7\3\2\2qr\7\27\2\2r#\3\2\2"+
		"\2st\7\3\2\2tu\7\27\2\2u%\3\2\2\2vw\7\3\2\2w|\7\27\2\2x|\7\26\2\2y|\7"+
		"\27\2\2z|\7\30\2\2{v\3\2\2\2{x\3\2\2\2{y\3\2\2\2{z\3\2\2\2|\'\3\2\2\2"+
		"\5/9{";
